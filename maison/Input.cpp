   ...
   while(SDL_PollEvent(&m_evenements)) {
      ...
      switch(m_evenements.type) {
        ...
        break;
         ...
         case SDL_KEYUP: // Cas d'une touche relâchée
            m_touches[m_evenements.key.keysym.scancode] = false;
        break;

         case SDL_MOUSEBUTTONDOWN: // Cas de pression sur un bouton de la souris
            m_boutonsSouris[m_evenements.button.button] = true;
        break;

         case SDL_MOUSEBUTTONUP: // Cas du relâchement d'un bouton de la souris
            m_boutonsSouris[m_evenements.button.button] = false;
        break;

         case SDL_MOUSEMOTION: // Cas d'un mouvement de souris
        ...
        break;
         ...
         case SDL_WINDOWEVENT: // Cas de la fermeture de la fenêtre
